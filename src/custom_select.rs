...
impl Select {
    ...
    #[inline]
    pub fn interact(self) -> Result<SelectOutput> {
    ...
    #[inline]
    pub fn interact_on(self, term: &Term) -> Result<SelectOutput> {
        Ok(self
    ...
    #[inline]
    pub fn interact_on_opt(self, term: &Term) -> Result<Option<SelectOutput>> {
        self._interact_on(term, true)
    }

    /// Like `interact` but allows a specific terminal to be set.
    fn _interact_on(self, term: &Term, allow_quit: bool) -> Result<Option<SelectOutput>> {
        if !term.is_term() {
